...
function getBook() {
  ...
  $.getJSON(openlibraryAPI, function(json) {
    ...
    var cover = json.docs[0].cover_i[0];
    ...
    var coverhere1 = json.docs[1].cover_i[0];
    coverhere1 = "https://covers.openlibrary.org/b/ID/" + coverhere1 + "-M.jpg";
    ...
    var cover1 = json.docs[1].cover_i[0];

    var coverhere2 = json.docs[2].cover_i[0];
    coverhere2 = "https://covers.openlibrary.org/b/ID/" + coverhere2 + "-M.jpg";
    ...
    var cover2 = json.docs[2].cover_i[0];

    var coverhere3 = json.docs[3].cover_i[0];
    coverhere3 = "https://covers.openlibrary.org/b/ID/" + coverhere3 + "-M.jpg";
    ...
    var cover3 = json.docs[3].cover_i[0];

    var coverhere4 = json.docs[4].cover_i[0];
    coverhere4 = "http://covers.openlibrary.org/b/ID/" + coverhere4 + "-M.jpg";
    ...
    var cover4 = json.docs[4].cover_i[0];

    var coverhere5 = json.docs[5].cover_i[0];
    coverhere5 = "https://covers.openlibrary.org/b/ID/" + coverhere5 + "-M.jpg";
    ...
    var cover5 = json.docs[5].cover_i[0];

    var coverhere6 = json.docs[6].cover_i[0];
    coverhere6 = "https://covers.openlibrary.org/b/ID/" + coverhere6 + "-M.jpg";
    ...
    var cover6 = json.docs[6].cover_i[0];

    var coverhere7 = json.docs[7].cover_i[0];
    coverhere7 = "https://covers.openlibrary.org/b/ID/" + coverhere7 + "-M.jpg";
    ...
    var cover7 = json.docs[7].cover_i[0];

    var coverhere8 = json.docs[8].cover_i[0];
    coverhere8 = "https://covers.openlibrary.org/b/ID/" + coverhere8 + "-M.jpg";
    ...
    var cover8 = json.docs[8].cover_i[0];

    var coverhere9 = json.docs[9].cover_i[0];
    coverhere9 = "https://covers.openlibrary.org/b/ID/" + coverhere9 + "-M.jpg";
    ...
    var cover9 = json.docs[9].cover_i[0];
